  ...
  cancel(id, params, cb) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (typeof params === 'function' || typeof cb === 'function') {
        ...
        const paymentId = get(params, 'paymentId') || _this4.parentId;
  ...
  cancel(id, params, cb) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (typeof params === 'function' || typeof cb === 'function') {
        ...
        const customerId = get(params, 'customerId') || _this5.parentId;
  ...
  get(id, params, cb) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (typeof params === 'function' || typeof cb === 'function') {
        ...
        const orderId = get(params, 'orderId') || _this3.parentId;
